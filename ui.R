...
shinyUI(navbarPage("Select the best car for your trip",
                   tabPanel("Table",
                            ...
                            sidebarLayout(
                              sidebarPanel(
                                helpText("Provide information about your trip and the carachteristics of the car that you want",style = "color:blue"),
                                numericInput('dis', 'Distance (in miles):', 500, min = 1, max = 1000),
